...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, Ctr_CKF_Pin|Ctr_FAN_Pin|Ctr_Lock_Pin
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, Heat_Ctrl_Pin|Dry_Ctrl_Pin|Hum_Ctrl_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = Dry_Ctrl_Pin|Hum_Ctrl_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = AirAdmissionCtrl_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(AirAdmissionCtrl_GPIO_Port, &GPIO_InitStruct);
